...
SECRET_KEY = 'django-insecure-*n#p@6(it#34b%x14w@zyy$+4y1kz#3cjh*j8rkd#co$)a@-6^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]#放到github，與render串接，任何ip可連接
...
INSTALLED_APPS = [
    ...
    'store.apps.StoreConfig',#要對應store.apps中的StoreConfig
]
